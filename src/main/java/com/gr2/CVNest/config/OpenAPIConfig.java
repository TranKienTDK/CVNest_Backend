...
public class OpenAPIConfig {
    ...
    private Info createApiInfo() {
        return new Info()
                .title("CVNEST Job Hunter API")
                .version("1.0")
                .contact(createContact())
                .description("This API exposes all endpoints (job hunter)")
                .termsOfService("https://itviec.com/")
    ...
    public OpenAPI myOpenAPI() {
        return new OpenAPI()
                ...
                .servers(List.of(
                        ...
                        createServer("https://itviec.com/", "Server URL in Production environment")))
